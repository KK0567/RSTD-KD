...
def main() -> None:
    ...
    parser.add_argument("--input-csv", type=str, default="../Data/ECU-IoFT-Dataset_w25.csv")
    parser.add_argument("--output-dir", type=str, default="Dataset_w25/ecu_attack_risk_windows_v3")
