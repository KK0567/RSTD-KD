...
MAIN_EXP_DIR = PROJECT_ROOT / "src" / "main_experiment"
DATA_PREP_SCRIPT = MAIN_EXP_DIR / "1_data_prep.py"
TEACHER_SCRIPT = MAIN_EXP_DIR / "2_teacher_train.py"
STUDENT_SCRIPT = MAIN_EXP_DIR / "3_student_train.py"
RAW_DATA_CSV = PROJECT_ROOT / "data" / "ECU-IoFT-Dataset.csv"
OUTPUT1_DIR = PROJECT_ROOT / "results" / "main" / "output1"  # pre-saved attack-stratified results
OUTPUT_BASE = PROJECT_ROOT / "results" / "main"  # for new outputs

REVISION_DIR = PROJECT_ROOT / "src" / "revision_experiments"
REVIEW_BASE = PROJECT_ROOT / "results"
